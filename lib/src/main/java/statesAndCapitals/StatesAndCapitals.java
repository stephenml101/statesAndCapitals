...
public class StatesAndCapitals
{
    ...
    public ArrayList<statesAndCapitals.StateInfo> readStatesAndCapitals() throws IOException
    {
        File statesAndCapitalsFile = new File(statesAndCapitalsFilePath);
        ArrayList<statesAndCapitals.StateInfo> states;
    ...
    {
        ArrayList<statesAndCapitals.StateInfo> states = readStatesAndCapitals();
        ...
        List<statesAndCapitals.StateInfo> firstFiveStates = states.stream().limit(5).collect(toList());
        ...
        List<statesAndCapitals.StateInfo> lastFiveStates = states.stream().skip(45).collect(toList());
        ...
        statesAndCapitals.StateInfo cardinalState = states.stream().filter(state -> state.getStateBird().equals("cardinal")).findAny().orElseThrow();
        ...
        statesAndCapitals.StateInfo stateWithLeastDistanceBetweenHighAndLowPoints = null;
