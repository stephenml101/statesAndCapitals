package main.java.statesAndCapitals;
...
{
    public static boolean basic1(List<statesAndCapitals.StateInfo> firstFiveStates)
    {
        ...
        for (statesAndCapitals.StateInfo state : firstFiveStates)
        {
    ...
    public static boolean basic2(List<statesAndCapitals.StateInfo> lastFiveStates)
    {
        ...
        for (statesAndCapitals.StateInfo state : lastFiveStates)
        {
    ...
    public static boolean int1(statesAndCapitals.StateInfo cardinalState)
    {
